...
export function TransactionRow({
  ...
  return (
    <>
      <div className="group flex items-center gap-3 border-b border-neutral-100 py-3 last:border-0">
        ...
        <div className="flex shrink-0 items-center gap-1">
          ...
          {showActions && (
            <DropdownMenu>
              <DropdownMenuTrigger className="ml-1 rounded p-1 text-neutral-400 opacity-0 transition-opacity group-hover:opacity-100 hover:bg-neutral-100 hover:text-neutral-700">
